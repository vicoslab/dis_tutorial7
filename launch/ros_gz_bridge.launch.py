...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('robot_name', default_value='turtlebot4', description='Gazebo model name'),
    DeclareLaunchArgument('dock_name', default_value='standard_dock', description='Gazebo model name'),
    DeclareLaunchArgument('namespace', default_value='', description='Robot namespace'),
    DeclareLaunchArgument('world', default_value='warehouse', description='World name'),
...
def generate_launch_description():
    ...
    ld.add_action(top_camera_camera_bridge)
    return ld
